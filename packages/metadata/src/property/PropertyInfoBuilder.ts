...
class PropertyInfoBuilder {
     ...
     * @return this
     */
    elementClass<T>(elementClass: ComponentClass<T>): this {
     ...
     * @return this
     */
    name(dependencyName: string): this {
     ...
     * @return this
     */
    private update(callback: (propertyInfo: PropertyInfo) => void): this {
        const propertyInfo: PropertyInfo = getPropertyInfo(this.target.constructor, <string> this.propertyKey) || {};
