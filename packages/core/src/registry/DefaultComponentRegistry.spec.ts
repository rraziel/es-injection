...
describe('Default component registry', () => {
    ...
    it('can get a component name from a component class', () => {
        ...
        componentRegistry.registerComponent('test', TestClass);
        // when
        const componentName: string|undefined = componentRegistry.getComponentName(TestClass);
        // then
    ...
    it('can get a component class from a component name', () => {
        ...
        componentRegistry.registerComponent('test', TestClass);
        // when
        const componentClass: ClassConstructor<TestClass>|undefined = componentRegistry.getComponentClass('test');
        // then
    ...
    it('can resolve a component class', () => {
        ...
        // when
        const implementationClasses: Set<ClassConstructor<TestClass>> = componentRegistry.resolveComponentClass(TestClass);
        // then
        expect(implementationClasses).toBeDefined();
