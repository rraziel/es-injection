...
class ReflectionUtils {
     ...
     */
    static getParameterClass<T>(componentClass: ComponentClass<T>, methodName: string, parameterIndex: number): ComponentClass<any> {
     ...
     */
    static getReturnClass<T>(typeClass: ComponentClass<T>, methodName: string|symbol): ComponentClass<any> {
