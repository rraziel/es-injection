...
describe('Type utility functions', () => {
    ...
    describe('can retrieve parent class information when there is', () => {
        ...
        it('a single parent', () => {
            ...
            class TestDerivedClass extends TestClass { }
            // when
            const parentClass: ComponentClass<any> = TypeUtils.getParentClass(TestDerivedClass);
            // then
        ...
        it('multiple ancestors', () => {
            ...
            const ancestorClass: ComponentClass<any> = TypeUtils.getParentClass(parentClass);
            // then
        ...
        it('no parent', () => {
            ...
            class TestClass { }
            // when
            const parentClass: ComponentClass<any> = TypeUtils.getParentClass(TestClass);
            // then
