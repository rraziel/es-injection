...
describe('Reflection utility functions', () => {
    ...
    it('can get a property class', () => {
        ...
        // when
        let prop1Class: ComponentClass<any> = ReflectionUtils.getPropertyClass(TestClass, 'prop1');
        let prop2Class: ComponentClass<any> = ReflectionUtils.getPropertyClass(TestClass, 'prop2');
        let prop3Class: ComponentClass<any> = ReflectionUtils.getPropertyClass(TestClass, 'prop3');
        // then
    ...
    it('can get a constructor parameter class', () => {
        ...
        // when
        let param0Class: ComponentClass<any> = ReflectionUtils.getParameterClass(TestClass, undefined, 0);
        let param1Class: ComponentClass<any> = ReflectionUtils.getParameterClass(TestClass, undefined, 1);
        let param2Class: ComponentClass<any> = ReflectionUtils.getParameterClass(TestClass, undefined, 2);
        // then
    ...
    it('can get a method parameter class', () => {
        ...
        // when
        let param0Class: ComponentClass<any> = ReflectionUtils.getParameterClass(TestClass, 'method', 0);
        let param1Class: ComponentClass<any> = ReflectionUtils.getParameterClass(TestClass, 'method', 1);
        let param2Class: ComponentClass<any> = ReflectionUtils.getParameterClass(TestClass, 'method', 2);
        // then
        expect(param0Class).toBe(Number);
        expect(param1Class).toBe(String);
        expect(param2Class).toBe(TestParameterClass);
    ...
    it('can get a method return class', () => {
        ...
        // when
        let returnClass: ComponentClass<any> = ReflectionUtils.getReturnClass(TestClass, 'method');
        // then
