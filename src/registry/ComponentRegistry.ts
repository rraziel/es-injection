...
abstract class ComponentRegistry {
     ...
     */
    abstract getComponentName<T>(componentClass: ComponentClass<T>): string;
     ...
     * @param <T>            Component type
     */
    abstract registerComponent<T>(componentName: string, componentClass: ClassConstructor<T>): void;
